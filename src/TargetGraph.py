    ...
    for model in structure:
        for chain in model:
            for residue in chain:
                if residue.get_id()[0] == ' ' and residue.get_resname() != "HOH":  # 排除水分子
...
for index, row in data.iterrows():
    ...
    if start_saving:
        ...
        structure_file = f'/home/user/sgp/Chemgenomic/target/MM-IDTarget/data/structure/{target_id}.pdb'
